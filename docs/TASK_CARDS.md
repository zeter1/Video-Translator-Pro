...
| `batch_start` | Batch start / validation / output directory | `videotranslator/ui/batch_start.py` | `videotranslator/recovery/batch.py`, `videotranslator/ui/queue.py` | 0 |
...
| `tts_cache` | TTS cache / recovery / cleanup / size | `videotranslator/tts/cache.py` | `videotranslator/pipeline/tts_prepare.py` | 4 |
